...
namespace DAL.manager
{
    ...
    {
        /// <summary>
        ///     <header> public static int agregrarDepartamentoDAL(clsLeaderboard oLeaderboard)</header>
        ...
        public static int agregrarDepartamentoDAL(clsLeaderboard oLeaderboard)
        {
            int result = 0;
